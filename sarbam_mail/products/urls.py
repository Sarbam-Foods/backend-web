...
urlpatterns = [
   ...
   path('cart/item/<str:product_id>/add/', views.AddProductToCartAPIView.as_view(), name='add_to_cart'),
   path('cart/item/<str:product_id>/cancel/', views.CancelCartProductAPIView.as_view(), name='cancel_cart_item'),
   
   path('cart/deals/<str:id>/add/<str:deal_type>/', views.AddDealsToCartAPIView.as_view(), name='deals_to_cart'),
