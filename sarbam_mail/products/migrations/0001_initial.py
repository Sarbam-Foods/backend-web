...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ComboDeal',
            fields=[
                ('combo_id', models.CharField(editable=False, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Placed', 'PLACED'), ('Shipped', 'SHIPPED'), ('Out for Delivery', 'OUT FOR DELIVERY'), ('Delivered', 'DELIVERED'), ('Cancelled', 'CANCELLED')], default='PENDING')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.FloatField(validators=[django.core.validators.MinValueValidator(0)])),
                ('status', models.CharField(choices=[('Placed', 'PLACED'), ('Confirmed', 'CONFIRMED'), ('Cancelled', 'CANCELLED')], default='PLACED')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Pending', 'PENDING'), ('Placed', 'PLACED'), ('Cancelled', 'CANCELLED')], default='Pending')),
